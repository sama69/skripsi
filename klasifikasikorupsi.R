...
dataDirectory <- "E:/skripsi/datakorupsi" # put your own folder here
#data <- read.csv("E:/datamerek/datamerek.csv", sep=",", header = TRUE)

df <- read_excel("E:/skripsi/datakorupsi.xlsx")
